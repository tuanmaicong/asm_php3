                ...
                <div class="double-scroll">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center"><a style="color:#333333;font-weight: bold;" href="" style="white-space:unset;text-align: justify;">{{$l->ten_danh_muc}}<i class="fa fa-edit"></i></a></td>
                            <td class="text-center">
                                ...
                                <button type="button" class="btn btn-danger"><a href="{{route('route_BackEnd_NguoiDung_delete',['id'=>$l->id])}}}}" style="color:white" onclick="return confirm('Bạn có chắc muốn xóa danh mục:{{$l->ten_danh_muc}}')">Delete</a></button>
                            </td>
                        </tr> @endforeach
                    </table>
                </div>
