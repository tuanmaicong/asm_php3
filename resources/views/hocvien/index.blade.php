                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($list as $u)
                            <tr>
                                ...
                                <td class="text-center"><a style="color:#333333;font-weight: bold;" href="{{route('route_BackEnd_hocvien_detail',['id'=>$u->id])}}" style="white-space:unset;text-align: justify;">{{$u->ten_hoc_vien}}<i class="fa fa-edit"></i></a></td>
                                <td class="text-center">{{$u->dia_chi}}</td>
                                <td class="text-center">{{$u->email}}</td>
                                <td class="text-center">{{$u->so_dien_thoai}}</td>
                                <td class="text-center">{{$u->so_cmt}}</td>
                                <td class="text-center">{{$u->trang_thai}}</td>
                                <td class="text-center">
                                    <button type="button" class="btn btn-primary"><a href="{{route('route_BackEnd_hocvien_detail',['id'=>$u->id])}}" style="color:white">Update</a></button>
                                    <button type="button" class="btn btn-danger"><a href="{{route('route_BackEnd_hocvien_delete',['id'=>$u->id])}}}}" style="color:white" onclick="return confirm('Bạn có chắc muốn xóa học viên:{{$u->ten_hoc_vien}}')">Delete</a></button>
                                </td>
                            </tr>
                        @endforeach
                    </table>
