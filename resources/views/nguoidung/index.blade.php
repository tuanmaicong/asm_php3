                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($list as $u)
                            <tr>
                                ...
                                <td class="text-center"><a style="color:#333333;font-weight: bold;" href="{{route('route_BackEnd_User_detail',['id'=>$u->id])}}" style="white-space:unset;text-align: justify;">{{$u->name}} <i class="fa fa-edit"></i></a></td>

                                <td class="text-center">{{$u->email}}</td>
                                <td class="text-center"><img id="mat_truoc_preview"
                                                             src="{{ $u->hinh?''.Storage::url($u->hinh):'http://placehold.it/100x100' }}"
                                                             alt="your image"
                                                             style="max-width: 200px; height:100px; margin-bottom: 10px;" class="img-responsive"/></td>
                                <td class="text-center">
                                    <button type="button" class="btn btn-primary"><a href="{{route('route_BackEnd_User_detail',['id'=>$u->id])}}" style="color:white">Update</a></button>
                                    <button type="button" class="btn btn-danger"><a href="{{route('route_BackEnd_User_delete',['id'=>$u->id])}}}}" style="color:white" onclick="return confirm('Bạn có chắc muốn xóa nguoidung:{{$u->name}}')">Delete</a></button>
                                </td>
                            </tr>
                        @endforeach
                    </table>
