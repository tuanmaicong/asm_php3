                ...
                <div class="double-scroll">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center"><a style="color:#333333;font-weight: bold;" href="" style="white-space:unset;text-align: justify;">{{$l->ten_giang_vien}}<i class="fa fa-edit"></i></a></td>
                            <td class="text-center"><a style="color:#333333;font-weight: bold;" href="" style="white-space:unset;text-align: justify;">{{$l->gioi_thieu}}</a></td>
                            <td class="text-center"><a style="color:#333333;font-weight: bold;" href="" style="white-space:unset;text-align: justify;">{{$l->id_lop}}</a></td>
                            <td class="text-center">
                                <button type="button" class="btn btn-primary"><a href="{{route('route_BackEnd_giangvien_detail',['id'=>$l->id])}}" style="color:white">Update</a></button>
                                <button type="button" class="btn btn-danger"><a href="{{route('route_BackEnd_giangvien_delete',['id'=>$l->id])}}}}" style="color:white" onclick="return confirm('Bạn có chắc muốn xóa giảng viên:{{$l->ten_giang_vien}}')">Delete</a></button>
                            </td>
                        </tr> @endforeach
                    </table>
                </div>
