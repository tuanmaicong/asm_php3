@php
    $objectUser=\Illuminate\Support\Facades\Auth::user();
@endphp
    <!DOCTYPE html>
<html>
<head>
                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="hidden-xs">{{$objectUser->name}}</span>
                        </a>
                        <ul class="dropdown-menu">
                            <li>
                                <p style="padding: 10px;">
                                    <i class="fa fa-user"></i>{{$objectUser->email}}<br>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="clearfix">
                    <p class="text-info">{{$objectUser->email}}</p>
                </div>
            ...
            <ul class="sidebar-menu" data-widget="tree">
                <li class=" active menu-open ">
                    <a href="{{route('route_BackEnd_NguoiDung_index')}}"><i class="fa fa-user"></i> <span>Quản lý danh mục</span></a>
                    <ul class="treeview-menu">
                        <li><a href=""><i
                                    class="fa fa-circle-o"></i>danhmuc</a></li>
                    </ul>
                </li>
                <li class=" active menu-open ">
                    <a href="{{route('route_BackEnd_KhoaHoc_index')}}"><i class="fa fa-user"></i> <span>Quản lý khóa học</span></a>
                </li>
                <li class=" active menu-open ">
                    <a href="{{route('route_BackEnd_Lop_index')}}"><i class="fa fa-user"></i> <span>Quản lý lớp học</span></a>
                </li>
                <li class=" active menu-open ">
                    <a href="{{route('route_BackEnd_giangvien_index')}}"><i class="fa fa-user"></i> <span>Quản lý giảng vien</span></a>
                </li>
                <li class=" active menu-open ">
                    <a href="{{route('route_BackEnd_hocvien_index')}}"><i class="fa fa-user"></i> <span>Quản lý học viên</span></a>
                </li>
                <li class=" active menu-open ">
                    <a href="{{route('route_BackEnd_dangky_index')}}"><i class="fa fa-user"></i> <span>Quản lý đăng ký</span></a>
                </li>
                <li class=" active menu-open ">
                    <a href="{{route('route_BackEnd_danhgia_index')}}"><i class="fa fa-user"></i> <span>Quản lý đánh giá</span></a>
                </li>
            </ul>
        </section>
        <!-- /.sidebar -->
